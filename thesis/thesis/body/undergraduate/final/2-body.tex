...
\par 我们可以用includegraphics来插入现有的jpg等格式的图片，如\autoref{fig:zzuli-logo}。

\begin{figure}[ht]
    \centering
    \includegraphics[width=.4\linewidth]{logo/ZZULI Logo Blue.png}
    \caption{\label{fig:zzuli-logo}郑州轻工业大学Logo}
\end{figure}
